...
<script type="text/javascript"
	src="/konan/resources/JS/mypage/myinfo.js"></script>
	...
	<div class="row">
		<div class="col-lg-6" style="width: 80%;">
			...
			<div class="card shadow mb-4"
				style="width: 70%; float: right; height: 280px;">
				...
				<div class="card-body" style="width: 100%">
					...
					<br>
					<h2 style="position: absolute; left: 40%; top: 35%; float: left; font-family: 나눔스퀘어라운드">별명
						: ${sessionScope.loginMember.username}</h2>
					<h2 style="position: absolute; left: 40%; top: 50%; float: left; font-family: 나눔스퀘어라운드">아이디
						: ${sessionScope.loginMember.userid}</h2>
					<h2 style="position: absolute; left: 40%; top: 65%; float: left; font-family: 나눔스퀘어라운드">이메일
						: ${sessionScope.loginMember.email}</h2>
		...
		<div class="col-lg-6">
			...
			<div class="card shadow mb-4"
				style="width: 70%; float: left; height: 280px;">
				<div class="card-header py-3" style="width: 100%">
				...
				<div class="card-body" style="width: 100%;">
					<br>
					<h2
						style="position: absolute; top: 35%; float: left; margin-left: 10px;">
						접속 아이피 : ${sessionScope.ip}</h2>
					<h2
						style="position: absolute; top: 50%; float: left; margin-left: 10px;">
						브라우저 : ${sessionScope.brower}</h2>
					<h2
						style="position: absolute; top: 65%; float: left; margin-left: 10px;">
						운영체제 : ${sessionScope.os}</h2>
				</div>
