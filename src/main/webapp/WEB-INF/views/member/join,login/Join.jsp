...
<body>
	<form class="box" action="joinDo.do" method="post"
		...
		<img src="/konan/resources/image/normal.png" id="idcheck"
			style="width: 30px; height: 30px; float: right; margin-top: 5px;">
		<input type="text" id="id" name="userid" placeholder="아이디" required>

		<input type="text" name="username" placeholder="이름[닉네임]" required>

		<img src="/konan/resources/image/normal.png" id="pwcheck"
		...
		<input type="password" id="pwd" name="userpwd" placeholder="비밀번호"
			...
			placeholder="핸드폰 번호" required> <img
			src="/konan/resources/image/normal.png" id="emailCheck"
			style="width: 30px; height: 30px; float: right; margin-top: 15px;">
		<input type="email" id="email" name="email" placeholder="이메일 주소"
			required>

		<input id="sub" type="submit" value="가입">
		<div id="loading" class="box1" style="margin: 40px 50% auto; margin-bottom: -15px; width: 200px; display:none;">
		<br>
			<span class="s1"></span> <span class="s2"></span> <span class="s3"></span><br>
			<font style="font-family: 나눔스퀘어라운드; font-size: 10pt; color: white;">잠시만 기다려주세요..<br> 가입 처리중입니다.</font>
		</div>
		...
		<font style="color: white;">가입하면 KONAN의 약관, 데이터 정책 및 쿠키 정책에
			동의하게 됩니다.</font>
		<hr>
