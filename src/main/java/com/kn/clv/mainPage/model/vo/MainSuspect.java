package com.kn.clv.mainPage.model.vo;
...
public class MainSuspect {
	...
	public MainSuspect(int suspect_no, String suspect_name, String suspect_bank, String suspect_account,
	...
	public String toString() {
		return "Suspect [suspect_no=" + suspect_no + ", suspect_name=" + suspect_name + ", suspect_bank=" + suspect_bank
				...
				+ suspect_count + ", report_date=" + report_date + "]";
	}
