...
public class Searchsuspect implements java.io.Serializable{
	...
	public Searchsuspect(int suspect_no, String suspect_name, String suspect_bank, String suspect_account,
			String suspect_phone, int suspect_count, Date report_date) {
		super();
	...
	public String toString() {
		return "Searchsuspect [suspect_no=" + suspect_no + ", suspect_name=" + suspect_name + ", suspect_bank="
				+ suspect_bank + ", suspect_account=" + suspect_account + ", suspect_phone=" + suspect_phone
				+ ", suspect_count=" + suspect_count + ", report_date=" + report_date + "]";
	}
}
